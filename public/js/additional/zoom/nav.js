...
function websdkready() {
    ...
    var SDK_KEY = "PfiHoR1kRl2IuWxKlgrdh3Lj3YWm63loAaJu";
     ...
     */
    var SDK_SECRET = "z9uGh8FUNxOv7ORq2SZA4japMBMF42vmrcOQ";
    ...
    var buttons = document.getElementsByClassName("join_meeting");
    for (var i = 0; i < buttons.length; i++) {
        buttons[i].onclick = function (e) {
            ...
            document.getElementById("meeting_number").value = this.dataset.mn;
            document.getElementById("meeting_pwd").value = this.dataset.pwd;
            document.getElementById("meeting_lang").value = "en-US";
            document.getElementById("meeting_role").value = this.dataset.role;
            ...
            //console.log('dfdf',this.dataset.url);
            ...
            var signature = generateSDKSignature({
                ...
                success: function (res) {
                    ...
                    if (document.getElementById("demoType").value === "cdn") {
                        var joinUrl = url + testTool.serialize(meetingConfig);
                        window.location.href = joinUrl;
                    } else {
                        var joinUrl =
                            "/index.html?" + testTool.serialize(meetingConfig);
                        window.location.href = joinUrl;
                    }
                },
            });
            ...
            success: function (res) {
                ...
                if (document.getElementById("demoType").value === "cdn") {
                    var joinUrl =
                        ...
                        "http://localhost/newness/teacher/live_classes/meeting?" +
