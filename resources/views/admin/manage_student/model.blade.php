          ...
          <div class="userprofalldata-iner model-form">
            ...
            <form id="userform">
              ...
              <div class="row">
                <div class="col-sm">
                  <div class="form-group">
                    <label for="">Select Trainee Class *</label>
              ...
              <div class="row">
                <div class="col-sm">
                  <div class="form-group">
                    <label for="password">External ID</label>
                    <input type="text" class="form-control" id="external_id" name="external_id" placeholder="">
                  </div>
                </div>
              </div>
              <br><br>
