    ...
    <div class="quizmaindata-cover">
        ...
        <div class="addadmsupbtnright">
            <a href="javascript:void(0)" id="create-class-list">
                <i class='bx bxs-plus-circle'></i> Add Page
            </a>
        </div>
    </div>
    <div class="mainquizans-cover">
        <div class="supadmmain_cover">
            <div class="supadmmain_maintbl">
                ...
                <table id="example" class="display table nowrap page_datatable">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Title</th>
...
<script type="text/javascript">
    var store = <?php echo json_encode(route('page.store')) ?>;
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.success) {
                        ...
                        $('.page_datatable').DataTable().draw(true);
                        setTimeout(function() {
    ...
    $('body').on('click', '.edit-class-list', function() {
        ...
        $('#alert-danger-form').hide();
        $('#alert-success-form').hide();
        $.get("{{ url('admin/'.$urlSlug.'/') }}" + '/' + page_id + '/edit', function(data) {
            var base_url = '<?php echo url('/'); ?>';
            $('#ajaxModel').modal('show');
            $('#page_id').val(data.data.id);
